...
مسیر رسمی دسکتاپ: **`Sirman.exe`** (پوشه `desktop/Sirman_Install_Kit`). جایگزین: `Sirman_Start.bat` (سرور محلی + پل اعلان مرکز اعلان ویندوز).
...
## نسخهٔ فعلی
سیرمان: **`Sirman_Final.html` → ۱۴۰۵.۵.۲۰γ** — اجرا با `Sirman_Start.bat`
