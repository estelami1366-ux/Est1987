...
حذف برنامه، بک‌آپ دستی شما را پاک نمی‌کند؛
ولی داده داخل همان پوشه نصب از بین می‌رود.
قبل از حذف بک‌آپ بگیرید.
"""
...
def build_docx():
    ...
    add_p(doc, "منوی Start → حذف سیرمان، یا Uninstall-Sirman.bat داخل پوشه نصب.")
    add_p(doc, "قبل از حذف از «ورود/خروج داده» بک‌آپ بگیرید.")
